    ...
    <>
      ...
      <main className={`${styles.main} ${inter.className}`}>
        ...
        <div className={styles.grid}>
          ...
          >
            <AnimatedImage style={{ width: WIDTH, height: WIDTH, }} alt="래시플_남성용_루즈핏박시_래쉬가드_상하의_세트" src={"/images/래시플_남성용_루즈핏박시_래쉬가드_상하의_세트.jpg"} springProps={{
          ...
          <a
            ...
            rel="noopener noreferrer"
          >
            <AnimatedImage style={{ width: WIDTH, height: WIDTH, }} alt="래시플 프리미엄 극세사 전동휠체어용 무릎담요 입는담요" src={"/images/래시플 프리미엄 극세사 전동휠체어용 무릎담요 입는담요.jpg"} springProps={{
          ...
          <a
            ...
            rel="noopener noreferrer"
          >
            <AnimatedImage style={{ width: WIDTH, height: WIDTH, }} alt="래시플 여성엄마 가오리 루즈핏 래쉬가드 빅사이즈수영복 stripe" src={"/images/래시플 여성엄마 가오리 루즈핏 래쉬가드 빅사이즈수영복 stripe.jpg"} springProps={{
              from: { opacity: 0, transform: "translate3d(0, 100%, 0)" },
              to: { opacity: 1, transform: "translate3d(0, 0, 0)" },
          ...
          <a
            ...
            rel="noopener noreferrer"
          >
            <AnimatedImage style={{ width: WIDTH, height: WIDTH, }} alt="래시플 쇼파쿠션커버 고급린넨스타일 9종 북유럽모던" src={"/images/래시플 쇼파쿠션커버 고급린넨스타일 9종 북유럽모던.jpg"} springProps={{
              from: { opacity: 0, transform: "translate3d(100%, 0, 0)" },
              to: { opacity: 1, transform: "translate3d(0, 0, 0)" },
